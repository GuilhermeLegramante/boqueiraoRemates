...
<div class="box box-default">
        ...
        <div class="box-header with-border">
            ...
            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">Remover Cliente</button>
        </div>
        ...
        <div class="modal fade" id="myModal" role="dialog">
            ...
            <div class="modal-content">
                ...
                <p>Deseja realmente remover o cliente {{"$cliente->nome"}}?</p>
                </div>
